...
public final class TailInteractionState {
    ...
    private static void requestNearestMaid() {
        ...
        MoreAnimationNetwork.CHANNEL.sendToServer(new TailInteractionRequestPacket(nearest.getId(), true));
    }
    ...
    public static void requestStop() {
        ...
        MoreAnimationNetwork.CHANNEL.sendToServer(new TailInteractionRequestPacket(oldMaid, false));
    }
    ...
    private static void sendPose(boolean holding) {
        ...
        MoreAnimationNetwork.CHANNEL.sendToServer(new TailPoseUpdatePacket(
